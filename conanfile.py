...
class HictkConan(ConanFile):
    ...
    def requirements(self):
        self.requires("abseil/20250127.0#9e8e8cfc89a1324139fc0ee3bd4d8c8c", force=True)  # otel and arrow
        self.requires("arrow/19.0.1#e5b40539e3f5411d03603a38b5fb698a")
        self.requires("boost/1.88.0#02627a4b63c60cef7daff8b936b121ff", force=True)
        ...
        self.requires("libcurl/8.12.1#130109dbd628be0f3d336b6a74b8b987", force=True)  # otel
