...
// Defines for MSVC
    ...
    #define HICTK_DISABLE_WARNING_CONVERSION                HICTK_DISABLE_WARNING(C4244)
    ...
    #define HICTK_DISABLE_WARNING_SIGN_CONVERSION           HICTK_DISABLE_WARNING(C4308 C4245 C4365)
