...
.. code-block:: bash
  ...
  mkdir /tmp/hictk
  curl -L 'https://github.com/paulsengroup/hictk/archive/refs/tags/v2.1.2.tar.gz' | tar --strip-components=1 -C /tmp/hictk -xzf -
...
.. code-block:: bash
  ...
  cd /tmp/hictk
  git checkout v2.1.2  # Skip this step if you want to build the latest commit from main
