...
function(_hictk_lock_and_configure_file PRE_CONFIGURE_FILE POST_CONFIGURE_FILE)
  if(NOT WIN32)
...
function(ConfigureVersioning input_config_folder output_config_folder)
  ...
  set(POST_CONFIGURE_FILE "${output_config_folder}/include/hictk/git.hpp")
  ...
  if(HICTK_ENABLE_GIT_VERSION_TRACKING)
    ...
    _hictk_lock_and_configure_file("${PRE_CONFIGURE_FILE}" "${POST_CONFIGURE_FILE}")
  endif()

  set(PRE_CONFIGURE_FILE "${input_config_folder}/version.hpp.in")
  set(POST_CONFIGURE_FILE "${output_config_folder}/include/hictk/version.hpp")
  _hictk_lock_and_configure_file("${PRE_CONFIGURE_FILE}" "${POST_CONFIGURE_FILE}")
