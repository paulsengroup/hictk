...
static py::object fetch(const hictk::hic::File& f, std::string_view range1, std::string_view range2,
                        std::string_view normalization, bool join, std::string_view query_type) {
  const auto qt =
      query_type == "UCSC" ? hictk::hic::File::QUERY_TYPE::UCSC : hictk::hic::File::QUERY_TYPE::BED;
