...
class HictkConan(ConanFile):
    ...
    def requirements(self):
        ...
        self.requires("fmt/11.0.2#5c7438ef4d5d69ab106a41e460ce11f3")
        self.requires("hdf5/1.14.4.3#df1467d7374938c231edbe10e83f2bb4")
        self.requires("highfive/2.10.0#3d1bd25944a57fa1bc30a0a22923d528", force=True)
